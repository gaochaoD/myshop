...
public class SendBeanMsg {
    ...
    public void send(String  msg){
        amqpTemplate.convertAndSend(RabbitMqBeanConfig.EXCHANGE,RabbitMqBeanConfig.KEY,msg);
    }

    public void sendMsgConverter(Product product){
        amqpTemplate.convertAndSend(RabbitMqBeanConfig.EXCHANGE,RabbitMqBeanConfig.KEY,product);
    }
